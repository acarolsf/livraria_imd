...
Você adicionou um livro <em>${livroAdicionado.titulo}</em> ao seu carrinho de compras.</font></h3>
</c:if>
...
<c:choose> 
     ...
     <p><strong><a href="${url}">Ver carrinho de compras</a>&nbsp;&nbsp;&nbsp;
...
<br>&nbsp;
<br>&nbsp;
<h3>Livros disponíveis para locação:</h3>
<div>
